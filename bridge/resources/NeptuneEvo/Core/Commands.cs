...
namespace NeptuneEvo.Core
{
    class Commands : Script
    {
        ...
        public static void CMD_chatMe(Client player, string msg)
        {
            ...
            RPChat("me", player, msg);
        }

        [Command("do", GreedyArg = true)]
        public static void CMD_chatDo(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
            ...
            msg = RainbowExploit(player, msg);
            RPChat("do", player, msg);
        }

        [Command("todo", GreedyArg = true)]
        public static void CMD_chatToDo(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
            ...
            RPChat("todo", player, msg);
        }

        [Command("s", GreedyArg = true)]
        public static void CMD_chatS(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
        ...
        public static void CMD_chatB(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
        ...
        public static void CMD_chatVh(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
            ...
            RPChat("vh", player, msg);
        }

        [Command("m", GreedyArg = true)]
        public static void CMD_chatM(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
        ...
        public static void CMD_chatT(Client player, string msg)
        {
            if (Main.Players[player].Unmute > 0)
            {
                Notify.Send(player, NotifyType.Error, NotifyPosition.BottomCenter, $"Вы замучены еще на {Main.Players[player].Unmute / 60} минут", 3000);
        ...
        public static void RPChat(string cmd, Client sender, string message)
        {
            NAPI.Task.Run(() =>
            {
                try

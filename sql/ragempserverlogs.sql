...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 09 2020 г., 09:51
...
--
-- База данных: `ragempserverlogs`
--
CREATE DATABASE IF NOT EXISTS `ragempserverlogs` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ragempserverlogs`;
-- --------------------------------------------------------

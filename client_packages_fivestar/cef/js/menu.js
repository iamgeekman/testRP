...
function openWorks(data){
    menu.reset();
    menu.self.attr('id', 'work');
    menu.self.children('h1').html("Устроиться на работу");
    ...
    menu.self.children('.buttons').children('#btn1').css('display','inline-block');
    menu.self.children('.buttons').children('#btn2').css('display','inline-block');
}

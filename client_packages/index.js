...
const walkstyles = [null,"move_m@brave","move_m@confident","move_m@drunk@verydrunk","move_m@shadyped@a","move_m@sad@a","move_f@sexy@a","move_f@scared"];
...
mp.game.streaming.requestClipSet("move_f@scared");
var admingm = false;
